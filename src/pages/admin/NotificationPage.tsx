    ...
    useEffect(() => {
        const client = new Client({
            ...
            onConnect: () => {
                ...
                client.subscribe("/topic/notifications/read", (message: IMessage) => {
                    const updated: Notification = JSON.parse(message.body);
        ...
        // ✅ cleanup sync
        return () => {
            client.deactivate(); // deactivate là sync, không cần await
        };
    }, []);
